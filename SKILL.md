...
version: 2.5.2
description: |
  Discipline Inspection v2.5.2 ⚔️ Methodology v2.3: Dual-Factor + 6 Modules + P1/P2 Framework + 10-Agent Full-Gate Pipeline + Resilience + LESSON(urgency routing) + Quality Dashboard + KG Activation + Agent Tuning + KG Writeback. Focused on party discipline inspection case analysis.
platforms:
  - openclaw
tools:
  - ripgrep
...
# Discipline-Inspection ⚔️ v2.5.2
...
### Agent 7: Publish (v2.5.2 — IMA Upload + LESSON Collection + Quality Dashboard)
...
**Step 7b — LESSON Collection (v2.4 → v2.5.2):** After upload, scan all agent output files for `[LESSON]` markers:
