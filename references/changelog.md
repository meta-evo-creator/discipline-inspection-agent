...
## v2.5.2 — Quick Install Release + English Localization (2026-07-26)

**Open-source release packaging.** Version bump from v2.5.1 with full English localization, case desensitization, and standardized README for public distribution.

**Files changed:**
- Modified: `SKILL.md` (version bump 2.5.1→2.5.2)
- Modified: `README.md` (version bump)
- Modified: `agents/publish.md` (version bump)
- Modified: `agents/analyze.md` (version bump)
